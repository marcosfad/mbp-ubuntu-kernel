...
APPLE_SMC_DRIVER_COMMIT_HASH=67a840b1cbe317f2f92b12cd167923beda863081
## BCE
...
done < <(find "${BUILD_PATH}/linux-mbp-arch" -type f -name "*.patch" | grep -v "linux-mbp-arch/00" | sort)
